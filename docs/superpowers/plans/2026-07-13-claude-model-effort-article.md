...
- Modify: `public/search-index.json` — durch den Build erzeugter Sucheinstieg für die neue Source Note.
...
- [x] **Step 1: Primär- und Zusatzquelle vollständig erfassen**
...
- [x] **Step 2: Bildrechte aus offiziellen Bedingungen belegen**
...
- [x] **Step 3: Zulässige Bilder herunterladen und technisch prüfen**
...
- [x] **Step 4: Medieninventar gegen Artikelstruktur prüfen**
...
- [x] **Step 1: Frontmatter mit Projektschema anlegen**
...
- [x] **Step 2: Deutsche adaptive Synthese schreiben**
...
- [x] **Step 3: Bilder, Quellen und Verbindungen einfügen**
...
- [x] **Step 1: Knowledge-Curator-Validator ausführen**
...
- [x] **Step 2: Validatorfehler gezielt beheben und erneut prüfen**
...
- [x] **Step 3: Relevanten Projekt-Build ausführen**
...
- [x] **Step 4: Arbeitsbaum und Assets abschließend prüfen**
...
- [x] **Step 5: Artikeländerungen committen**
