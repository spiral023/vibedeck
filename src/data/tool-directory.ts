...
import { Terminal, Rocket, Code2, Zap, Palette, Boxes, Database, Cloud, Brain } from 'lucide-react';
...
export const toolCategories: ToolCategory[] = [
  ...
  {
    name: 'App Generators & Prototyping',
    tools: [
  ...
  {
    name: 'UI Design & Component Libraries',
    tools: [
  ...
  },
  {
    ...
    tools: [
      ...
      { name: 'Brave Search API', description: 'Web Search API mit eigenem Index und Echtzeit-Updates.', url: 'https://api-dashboard.search.brave.com/app/dashboard', icon: Zap },
      { name: 'SerpApi', description: 'Google Search API mit Proxy-Handling, Captcha-Loesung und Parsing.', url: 'https://serpapi.com/', icon: Zap },
    ],
  },
  {
    name: 'Dev Utilities & Documentation',
    tools: [
