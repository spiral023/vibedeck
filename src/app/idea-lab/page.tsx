...
const projectTypes = [
  ...
  'Chat Application',
  'Booking System',
  'Projektmanagement Tool (Kanban/Scrum)',
  'CRM für kleine Unternehmen',
  'Invoice & Angebots-Generator',
  'Subscription Management Portal',
  'Customer Support Helpdesk / Ticket-System',
  'Knowledge Base / Wiki',
  'Form Builder / Survey Tool',
  'Online Kurs-/Coaching Plattform',
  'Community Forum / Q&A Plattform',
  'Job Board / Bewerber-Tracking (ATS Light)',
  'Terminplaner für Dienstleister (Calendly-Style)',
  'Restaurant Tischreservierungssystem',
  'Immobilien-Listing Plattform',
  'Marketplace für digitale Downloads',
  'Auktionsplattform / Bidding App',
  'Kleinanzeigen-Plattform',
  'Preisvergleich / Deal Aggregator',
  'Reiseplaner / Itinerary Builder',
  'Habit Tracker / Goal Tracker',
  'Personal Finance / Budget Planner',
  'Expense Tracker für Teams',
  'Inventory Management (Lagerverwaltung)',
  'Asset Management (IT/Equipment)',
  'Timesheet / Zeiterfassung',
  'Shift Planner / Dienstplaner',
  'Recruiting Scheduling / Interview Hub',
  'OKR Tracker / KPI Dashboard',
  'Content Calendar / Social Scheduler',
  'Email Newsletter Builder (Mini-Mailchimp)',
  'A/B Testing Dashboard',
  'Feature Flag Management',
  'Uptime Monitor / Status Page',
  'Bug Tracker / Issue Tracker',
  'Changelog & Release Notes Portal',
  'API Key Management & Developer Portal',
  'File Sharing / Secure Document Vault',
  'E-Signature Workflow (Light)',
  'Password Manager (Team Vault Light)',
  'Link-in-Bio Builder',
  'URL Shortener mit Analytics',
  'Website Audit / SEO Checker',
  'AI Prompt Library / Prompt Manager',
  'Meeting Notes / Transcription Hub',
  'Whiteboard / Mindmap Tool',
  'Realtime Collaboration Editor (Docs-Light)',
  'Quiz & Exam Plattform',
  'Flashcard Learning App',
  'Event Ticketing + Check-in App',
  'Volunteer / Club Management',
  'Donation / Fundraising Plattform',
  'Loyalty / Rewards Portal',
  'Referral Program Manager',
  'Returns / RMA Portal (E-Commerce Support)',
  'Product Feedback Portal (Canny-Style)',
  'Onboarding Checklist / User Journey Builder',
